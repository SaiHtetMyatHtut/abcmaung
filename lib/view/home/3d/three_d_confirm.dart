...
class ThreeDConfirm extends StatelessWidget {
  ThreeDConfirm({Key? key}) : super(key: key);
      ...
      content: Padding(
        ...
        child: Column(
          children: [
            hololo(
              content:
                  'On ^$date morning 12:00 am the Lucky Number will announce and we wish you a great good luck.',
            ),
            const SizedBox(
              height: 40.0,
            )
